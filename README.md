...
Data is hosted in the [Cell Painting Gallery](https://github.com/broadinstitute/cellpainting-gallery).

Please use [issues in this repository](https://github.com/jump-cellpainting/datasets/issues) to ask any questions about the JUMP datasets.
