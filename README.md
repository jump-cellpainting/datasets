...
This repository contains notebooks and instructions to work with the datasets. The URLs to the datasets can be found [here](https://github.com/jump-cellpainting/datasets/blob/main/profiles_index.csv).
